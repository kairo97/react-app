...
function Me() {
  ...
  <div className="bio">
      ...
      <p id="myBio"> I am a fullstack developer who is new to the industry, I have skills involving HTML, CSS, JavaScript, Jquery, NodeJS, React, MySql, sequelize,MongoDB, Mongoose, handlebars, and React-Router. </p>
